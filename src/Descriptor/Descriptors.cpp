...
VgeDescriptorSetLayout::VgeDescriptorSetLayout(
    ...
    if (vkCreateDescriptorSetLayout(vgeDevice.device(), &descriptorSetLayoutInfo, nullptr,
...
VgeDescriptorPool::Builder& VgeDescriptorPool::Builder::addPoolSize(VkDescriptorType descriptorType,
                                                                    uint32_t count) {
...
VgeDescriptorPool::VgeDescriptorPool(VgeDevice& vgeDevice, uint32_t maxSets,
...
bool VgeDescriptorPool::allocateDescriptor(const VkDescriptorSetLayout descriptorSetLayout,
...
void VgeDescriptorPool::freeDescriptors(std::vector<VkDescriptorSet>& descriptors) const {
    vkFreeDescriptorSets(vgeDevice.device(), descriptorPool,
...
VgeDescriptorWriter& VgeDescriptorWriter::writeBuffer(uint32_t binding,
...
VgeDescriptorWriter& VgeDescriptorWriter::writeImage(uint32_t binding,
